...
from keras.layers import Dense, Input, Embedding, Reshape, Concatenate, Lambda, LeakyReLU
import keras
...
h1 = Dense(units = 400)(embeddings)
h1_lrelu = LeakyReLU()(h1)
h2 = Dense(units = 400, activation = 'relu')(h1_lrelu)
h2_lrelu = LeakyReLU()(h2)

q = Dense(units = 93, activation = 'softmax')(h2_lrelu)
...
model.save(filepath = 'saved_models/model3.h5')
